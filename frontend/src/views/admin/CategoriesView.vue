  ...
  <div class="admin-categories space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <Button
        ...
        icon="pi pi-plus"
        class="!bg-indigo-600 hover:!bg-indigo-700 !border-indigo-600 !rounded-xl !px-5 !py-2.5 !font-semibold !text-sm shadow-md shadow-indigo-200"
        ...
        <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto flex-1">
          ...
          <div class="relative w-full sm:w-80">
            ...
            <input
              ...
              class="w-full pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-medium focus:border-indigo-500 focus:outline-none transition-all"
            />
          </div>
          ...
          <div class="w-full sm:w-auto">
            <Select
              ...
              class="!h-10 min-w-[210px] !rounded-xl !text-xs"
            />
          </div>
        </div>
