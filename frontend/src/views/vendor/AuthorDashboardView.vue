...
const fetchStats = async () => {
  try {
    ...
    books.value = [
      { id: 1, title: 'Bóng Tối Sau Lưng', type: 'ebook', status: 'published', chapters_count: 24, price: 59000 },
      { id: 2, title: 'Ngày Mai Gió Thổi', type: 'ebook', status: 'draft', chapters_count: 18, price: 49000 },
      { id: 3, title: 'Ký Ức Thành Phố', type: 'book', status: 'published', stock: 120, price: 95000 },
    ]
  } finally {
    loading.value = false
  }
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      ...
      <div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between relative overflow-hidden">
        ...
        <div class="mt-6 flex items-center justify-between text-xs font-medium text-slate-500">
          ...
          <span class="text-emerald-600 font-semibold"><i class="pi pi-arrow-up mr-1"></i>+12.4% tháng này</span>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between relative overflow-hidden">
        ...
        <div class="mt-6 flex items-center justify-between text-xs font-medium text-slate-500">
          ...
          <span class="text-emerald-600 font-semibold"><i class="pi pi-arrow-up mr-1"></i>+8.2% tuần này</span>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between relative overflow-hidden">
        ...
        <div class="mt-6 flex items-center justify-between text-xs font-medium text-slate-500">
          <span>Sách cũ ký gửi: 1 gian</span>
          <span class="text-slate-400 font-medium">Bản quyền DRM: Đã kích hoạt</span>
        </div>
      </div>
    </div>
