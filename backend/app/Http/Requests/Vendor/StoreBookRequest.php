...
class StoreBookRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'format' => ['nullable', Rule::in(['physical', 'ebook'])],
            'provenance' => ['nullable', Rule::in(['self_published', 'used_resale', 'publisher_catalog'])],
            'condition' => ['nullable', Rule::in(['new', 'like_new', 'good', 'fair'])],
            'fulfillment_mode' => ['nullable', Rule::in(['digital', 'seller_verified_address', 'vendor_warehouse'])],
